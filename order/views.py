...
# serializer
from .serializers import CodOrderSerializer, CustomOrderSerializer

# model
from .models import CodOrder, CusotmOrder
...
@extend_schema(tags=["Custom-Order"])
class CustomOrderView(viewsets.GenericViewSet):
    permission_classes = [IsAuthenticated]
    serializer_class = CustomOrderSerializer
    queryset = CusotmOrder.objects.all()
    pagination_class = DefaultPagination
    filter_backends = [SearchFilter, DjangoFilterBackend, OrderingFilter]
